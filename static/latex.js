[
    ...
    { trigger: "vph", replacement: "\\varphi", options: "mA" },
    { trigger: "vPh", replacement: "\\varPhi", options: "mA" },
    { trigger: "eps", replacement: "\\epsilon", options: "mA" },
    { trigger: "lam", replacement: "\\lambda", options: "mA" },
    { trigger: "vep", replacement: "\\varepsilon", options: "mA" },
    ...
    { trigger: "mean", replacement: "\\mathrm{mean}", options: "mA" },
    { trigger: "abs", replacement: "\\mathrm{abs}", options: "mA" },
    ...
    { trigger: "tran", replacement: "^{\\intercal}", options: "mA" },
    ...
    // text color
    { trigger: "r", replacement: "\\textcolor{red}{${VISUAL}}", options: "mA" },
    { trigger: "g", replacement: "\\textcolor{green}{${VISUAL}}", options: "mA" },
    { trigger: "b", replacement: "\\textcolor{blue}{${VISUAL}}", options: "mA" },
    ...
    { trigger: "exi", replacement: "\\exists", options: "mA", priority: 1 },
    ...
    { trigger: "\\gt~", replacement: "\\succ", options: "mA" },
    { trigger: "<~", replacement: "\\succ", options: "mA" },
    { trigger: "\\lt~", replacement: "\\prec", options: "mA" },
    { trigger: "\\succ=", replacement: "\\succsim", options: "mA" },
    { trigger: "\\prec=", replacement: "\\precsim", options: "mA" },
    { trigger: "\\geq~", replacement: "\\gtrsim", options: "mA" },
    { trigger: "\\leq~", replacement: "\\lesssim", options: "mA" },
    ...
    { trigger: "([a-zA-Z])p1", replacement: "[[0]]_{n+1}", options: "rmA" },
    ...
    { trigger: "argmax", replacement: "\\underset{$0}{\\arg\\max}\\,", options: "mA" },
    { trigger: "argmin", replacement: "\\underset{$0}{\\arg\\min}\\,", options: "mA" },
    { trigger: "s.t.", replacement: "\\mathrm{s.t.}", options: "mA" },
    ...
    { trigger: "aalign", replacement: "\\begin{alignat}{2}\n$0\n\\end{alignat}", options: "mA" },
    ...
    { trigger: "lrv", replacement: "\\left| $0 \\right| $1", options: "mA" },
    { trigger: "lr|", replacement: "\\left| $0 \\right| $1", options: "mA" },
    { trigger: "lrV", replacement: "\\left\\Vert $0 \\right\\Vert $1", options: "mA" },
    { trigger: "lr{", replacement: "\\left\\{ $0 \\right\\} $1", options: "mA" },
    { trigger: "lr[", replacement: "\\left[ $0 \\right] $1", options: "mA" },
    ...
    { trigger: "lpmax", replacement: "\\begin\{alignat\}\{2\}\n\\max \\quad& $1 \\\\\n\\mathrm\{s.t.\} \\quad\n& $2 \\\\\n\\end\{alignat\}", options: "mA" },
    { trigger: "lpmin", replacement: "\\begin\{alignat\}\{2\}\n\\min \\quad& $1 \\\\\n\\mathrm\{s.t.\} \\quad\n& $2 \\\\\n\\end\{alignat\}", options: "mA" }
]